...
public class NegoChat extends AppCompatActivity implements View.OnClickListener {
    ...
    private BroadcastReceiver chatBroadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals("ChatBroadCast")) {
                try {
                    ...
                    if (orderId == Integer.parseInt(orderNumber)) {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nego_chat);
        LocalBroadcastManager.getInstance(NegoChat.this).registerReceiver(chatBroadcastReceiver, new IntentFilter("ChatBroadCast"));
        isChatActive = true;
        ...
        if (orderId > 0) {
            ...
            Common.showToast(NegoChat.this, getResources().getString(R.string.something_is_not_right), false);
    ...
    private void setAdapter() {
        chatAdapter = new ChatAdapter(NegoChat.this, datumArrayList);
        layoutManager = new LinearLayoutManager(NegoChat.this);
        ...
        Common.showDialog(NegoChat.this);
    ...
    private void settingRecordViewListener() {
        ...
        recordView.setOnRecordListener(new OnRecordListener() {
            ...
            public void onStart() {
                ...
                if (ContextCompat.checkSelfPermission(NegoChat.this, Manifest.permission.RECORD_AUDIO) == PackageManager.PERMISSION_DENIED
                        || ContextCompat.checkSelfPermission(NegoChat.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_DENIED) {
                    ActivityCompat.requestPermissions(NegoChat.this, new String[]{Manifest.permission.RECORD_AUDIO, Manifest.permission.WRITE_EXTERNAL_STORAGE}, 2003);
                } else {
            ...
            public void onCancel() {
                ...
                if (ContextCompat.checkSelfPermission(NegoChat.this, Manifest.permission.RECORD_AUDIO) == PackageManager.PERMISSION_GRANTED
                        || ContextCompat.checkSelfPermission(NegoChat.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                    shutDownRecorder();
                }
            }
    ...
    public void checkPermission(String permission, int requestCode) {
        ...
        if (ContextCompat.checkSelfPermission(NegoChat.this, permission) == PackageManager.PERMISSION_DENIED) {
            ActivityCompat.requestPermissions(NegoChat.this, new String[]{permission}, requestCode);
        } else {
    ...
    private void getMessageFromApi(int c) {
        ...
        Call<ChatModel> call = api.getChatMessages("Bearer " + SharedPreference.getSimpleString(NegoChat.this, Constants.accessToken),
                orderId, c);
        ...
        call.enqueue(new Callback<ChatModel>() {
            ...
            public void onResponse(Call<ChatModel> call, Response<ChatModel> response) {
                ...
                try {
                    if (response.isSuccessful()) {
                        ...
                        Common.showToast(NegoChat.this, jsonObject.getString("message"), false);
                        showNullMessage();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
            ...
            public void onFailure(Call<ChatModel> call, Throwable t) {
                Common.dissmissDialog();
                Log.d("NegoChat", "onFailure: " + t.getMessage());
                showNullMessage();
            }
        });
    ...
    private void postMessage(String message, File file, String type, String duration) {
        ...
        RequestBody rbOrderId = RequestBody.create(MediaType.parse("text/plain"), String.valueOf(orderId));
        ...
        if (type.equals("text")) {
            ...
            call = api.postTextMessage("Bearer " + SharedPreference.getSimpleString(NegoChat.this, Constants.accessToken),
            ...
            call = api.postFileMessage("Bearer " + SharedPreference.getSimpleString(NegoChat.this, Constants.accessToken),
    ...
    protected void onDestroy() {
        super.onDestroy();
//        isChatActive = false;
        LocalBroadcastManager.getInstance(NegoChat.this).unregisterReceiver(chatBroadcastReceiver);
        stopAudio();
    }
